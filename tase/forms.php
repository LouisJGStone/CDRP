                  ...
                  <div class="portlet light">
                    <div class="portlet-title">
                      <div class="caption">
                        ...
                        <span class="caption-helper">time for a new form</span>
                      </div>
                    </div>
                    <div class="portlet-body">
                    	<table class="table table-hover table-advanced table-bordered table-striped">
                    		<thead>
                    			<th>Name</th>
                    			<th>Code</th>
                    			<th>Actions</th>
                    		...
                    		<tbody>
                    			...
                    			$res = getConnection()->query("SELECT * FROM Forms;");
                    			...
                    			if ($res->num_rows > 0) {
                    				...
                    				while ($r = $res->fetch_assoc()) {
										...
										<tr>
                    						...
                    						<td>'.$r["Code"].'</td>
                    						<td>
                    							<button class="btn btn-xs green-stripe">Add Question</button>
                    							<button class="btn btn-xs red-stripe">Delete</button>
                    						</td>
                    					</tr>
                    					';
