                ...
                <div class="page-content" style="min-height: 1147px;">
                  ...
                  <div class="portlet light">
                    <div class="portlet-title">
                      <div class="caption">
                        <span class="caption-subject bold uppercase">APPLICATIONS</span>
                        <span class="caption-helper">hmmm, i need to recruit a new Sergeant...</span>
                      </div>
                      <div class="actions">
                        <a href="javascript:create();" class="btn btn-circle btn-default"><i class="fa fa-plus"></i> Create Application</a>
                        <script>
                        function create() {

                          var url = "popup_addapplication.php";
                          var w = 600;
                          var h = 500;
                    ...
                    <div class="portlet-body">
                      <table class="table table-advanced table-bordered table-advanced">
                        ...
                        <tbody>
                          ...
                          $res = $conn->query("SELECT * FROM Applications");

                          if ($res->num_rows > 0) {

                            while ($r = $res->fetch_assoc()) {

                              echo("<tr><td>".$r["ID"]."</td><td>".$r["Name"]."</td><td>".$r["Description"]."</td><td><a href=\"javascript:edit(".$r["ID"].")\" class=\"btn default green-stripe btn-xs\">Edit Questions</a> <a href=\"javascript:access(".$r["ID"].")\" class=\"btn default green-stripe btn-xs\">Edit Access</a></td></tr>");
