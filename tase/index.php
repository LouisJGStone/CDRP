                  ...
                  <div class="portlet light">
                    <div class="portlet-title">
                      <div class="caption">
                        ...
                        <span class="caption-helper">ooh, fancy stats</span>
                      </div>
                    </div>
                    <div class="portlet-body">
                      <div class="row">
                        <div class="col-xs-12 col-md-3 col-sm-3 col-xs-3">
                          <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                            ...
                            <div class="details">
                              <div class="number">
                                <span data-counter="counterup"><?php echo $totalIncidents; ?></span>
                              </div>
                              <div class="desc"> CAD'S CREATED </div>
                            </div>
                          </a>
                        </div>
                          </a>
